...
import { FaFreeCodeCamp, FaGift, FaMoneyBill } from "react-icons/fa";
...
export function CourseCard({
  ...
  return (
    <div className="border border-gray-200 p-4 rounded-md transition-all shadow shadow-gray-100 hover:scale-103 hover:shadow-2xl">
